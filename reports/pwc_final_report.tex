...
\begin{center}
  ...
  \vspace{0.55em}
  \infofield{Course}{\rule{3.2cm}{0.4pt}}
  \infofield{Student}{\rule{3.0cm}{0.4pt}}\\[0.35em]
  \infofield{Student ID}{\rule{2.6cm}{0.4pt}}
  \infofield{Instructor}{\rule{2.7cm}{0.4pt}}
  \infofield{Date}{\rule{2.2cm}{0.4pt}}
\end{center}
